...
export const promptLibraryCaptions = [
  "La consistencia no es un trade de suerte, es disciplina diaria. En TradeShare auditás tus números con la Bitácora Pro. 🚀 Registrate, creá tu comunidad y dominá tu riesgo. Entrá en trade-share.com y empezá a competir de verdad. 📈☕ #Trading #Consistencia #TradeShare",
  "Operar de noche requiere enfoque y silencio. En TradeShare te damos las herramientas profesionales para que audites tu trading con IA. Conectá tu MT5 y usá la Bitácora Pro en trade-share.com. 🌙✍️ #Psicotrading #Metricas #TradeShare",
  "El trading zen es posible cuando tenés las herramientas correctas y claridad de ratios. Creá tu comunidad, registrate y usá la Bitácora Pro en trade-share.com. ¡Sumate a la red institucional! ☀️🍵 #TradingZen #TradeShare",
  "Tu diario emocional es tu mejor aliado para erradicar el tilt. En TradeShare, la Bitácora Pro y la creación de comunidades son el estándar profesional. Sin excusas para no ser consistente. Entrá a trade-share.com 📔⌨️ #Psicotrading #SmartMoney #TradeShare",
  "Un espacio limpio, una mente clara y herramientas institucionales. En TradeShare tenés todo: bitácora, comunidades dedicadas y streaming en vivo. Registrate en trade-share.com y dominá el mercado. 🌿💻 #MinimalistTrading #Forex #TradeShare",
  "¿Respetaste tu plan hoy? Mostrá tu consistencia real con la Bitácora Pro de TradeShare. Creá tu propia comunidad y construí tu reputación en trade-share.com. 📚✨ #TradingReal #Discipline #TradeShare",
  "Tu trading es un negocio, y TradeShare es tu socio analítico. Bitácora Pro conectada a MT5 y gestión integral de comunidades. Empezá hoy en trade-share.com ☕📊 #Business #TradeShare",
  "¿Winrate del 40%? Es más que suficiente si tenés gestión matemática de riesgo. Auditá tus números con la Bitácora Pro de TradeShare. Registrate y creá tu comunidad en trade-share.com 👓🎯 #EducacionFinanciera #RiskManagement #TradeShare",
  "Libertad de tiempo y paz mental con herramientas profesionales de análisis. TradeShare es el ecosistema completo: Bitácora Pro, journal y comunidades. Unite en trade-share.com 🌇☕ #TradingLife #LibertadFinanciera #TradeShare",
  "Simplificá tu análisis y dejá hablar al precio. Usá TradeShare para trackear cada entrada. Bitácora Pro y comunidades en trade-share.com. Vamos a competir con los mejores. 💻🎯 #PriceAction #SMC #TradeShare",
  "Aceptá el drawdown como costo operativo y mejorá tus decisiones con IA. El auditor de TradeShare te muestra la verdad. Bitácora Pro y salas técnicas en trade-share.com. ¡Sumate ya! 📖☕ #Resiliencia #Mindset #TradeShare",
  "Tu plan es tu ley. TradeShare es tu herramienta clave para cumplirlo al pie de la letra. Bitácora Pro y creación de comunidades en trade-share.com 💻🛡️ #DisciplineWins #Rules #TradeShare",
  "Aprendé y debatí en comunidad profesional. En TradeShare podés crear tu propio espacio o unirte a otros analistas serios. Usá la Bitácora Pro en trade-share.com 🎙️📈 #Mentoria #ComunidadTrading #TradeShare",
  "Preparación + Oportunidad + Herramientas Pro = Éxito sostenido. Usá la Bitácora Pro de TradeShare. Registrate en trade-share.com y empezá a auditar tu proceso. ☕🖊️ #EstiloDeVida #Consistencia #TradeShare",
  "Operá desde cualquier lugar con tecnología institucional. TradeShare: comunidades activas, registro de trades y Bitácora Pro. Entrá en trade-share.com ☕📲 #DigitalNomad #Tech #TradeShare",
  "Colaboración profesional sin intermediarios ni ruido. En TradeShare creás tu comunidad oficial. Bitácora Pro y salas de streaming técnico en trade-share.com 🏢📊 #TradingPartners #TradeShare",
  "Lo que no se mide, no se puede mejorar. Medilo TODO con rigor matemático en TradeShare. Bitácora Pro automatizada y comunidades de élite en trade-share.com 📊🛡️ #IA #TradingMetrics #TradeShare",
  "Operá en las killzones institucionales y registrá cada confluencia en TradeShare. Bitácora Pro y comunidades profesionales. Entrá en trade-share.com ⏱️⌨️ #TimeIsMoney #Killzone #TradeShare",
  "La operación más rentable de la semana muchas veces es saber cuándo no operar. Registrá tu disciplina en TradeShare. Bitácora Pro y comunidades en trade-share.com ☀️🍵 #Psicotrading #PazMental #TradeShare",
  "Pasión, tecnología analítica y enfoque implacable. TradeShare te equipa con la Bitácora Pro y comunidades profesionales. Registrate en trade-share.com y vamos a competir. 🌌💻 #WorkHard #Focus #TradeShare",
  "Operá al aire libre, mantené la calma y respaldá tus decisiones en datos reales. TradeShare: Bitácora Pro y comunidades de traders en trade-share.com 🌇💻 #TradingMotivation #TradeShare",
  "Tratá el trading como un fondo cuantitativo con herramientas profesionales. Bitácora Pro y comunidades en TradeShare. Unite en trade-share.com ☕📄 #ProfessionalTrading #TradeShare",
  "Paciencia en mercados lentos y baja volatilidad. Registrá tu espera en TradeShare. Bitácora Pro y comunidades en trade-share.com 🌧️📲 #Patience #TradeShare",
  "Gráficos limpios y Bitácora Pro avanzada. En TradeShare podés crear tu comunidad y auditar tu trading con precisión. Entrá en trade-share.com 🪵📊 #SmartMoney #InstitutionalTrading #TradeShare",
  "Estudio riguroso respaldado por analítica de datos. TradeShare potencia tu camino con la Bitácora Pro y comunidades privadas. Registrate en trade-share.com 📚⏱️ #Consistency #TradeShare",
  "Gestión de riesgo matemática sin margen para la improvisación. Usá la Bitácora Pro de TradeShare para blindar tu cuenta. Creá tu comunidad en trade-share.com 🖋️🛡️ #RiskManagement #TradeShare",
  "Transparencia total de track record. En TradeShare las comunidades y la Bitácora Pro marcan el nuevo estándar. Unite a la red en trade-share.com 🏢🎙️ #TradingAcademy #TradeShare",
  "Ecosistema integrado de alto nivel. Bitácora Pro, comunidades y registro institucional en TradeShare. Entrá en trade-share.com 🌌💻 #TradingPremium #TradeShare",
  "Disciplina quirúrgica en cada sesión. Registrá tu consistencia en TradeShare. Bitácora Pro y comunidades en trade-share.com ⏱️📔 #Disciplina #Focus #TradeShare",
  "Automatización total para tu journal. Sincronizá MT5 con TradeShare y usá la Bitácora Pro. Creá tu comunidad en trade-share.com 💻🚀 #TradingAutomation #TradeShare",
  "Claridad absoluta y herramientas de vanguardia. Bitácora Pro y comunidades en TradeShare. Vamos a competir en trade-share.com 📱📊 #CleanCharts #TradeShare",
  "Paciencia aburrida, resultados consistentes y métricas comprobadas. Usá TradeShare: Bitácora Pro y comunidades en trade-share.com 📖☕ #PatiencePays #TradeShare",
  "Fundamentales sin ruido y registro claro de noticias de impacto. TradeShare te da la Bitácora Pro y salas de debate. Entrá en trade-share.com 📰☕ #Macroeconomics #TradeShare",
  "Planificación nocturna y herramientas de élite para la sesión asiática. Bitácora Pro y comunidades en TradeShare. Registrate en trade-share.com 🌌⌨️ #Preparation #TradeShare",
  "Transparencia innegable para tus inversores y comunidad. Mostrá tus métricas verificadas con la Bitácora Pro de TradeShare. Unite en trade-share.com 🏢🛡️ #FundManager #TradeShare"
];
